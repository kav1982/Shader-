...
namespace ShaderForge {
	...
	public class SF_PreviewWindow {
		...
		public void SetupPreview() {
            ...
            BindingFlags bfs = BindingFlags.Static | BindingFlags.Public;
            Type[] args = new Type[] { typeof(Camera) };
            mSetCameraOnlyDrawMesh = typeof(Handles).GetMethod("SetCamera", bfs, null, args, null);
            if (mSetCameraOnlyDrawMesh == null)
            {
                bfs = BindingFlags.Static | BindingFlags.NonPublic;
