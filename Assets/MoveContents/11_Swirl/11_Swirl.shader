    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_9338 = (mul(i.uv0-node_9338_piv,float2x2( node_9338_cos, -node_9338_sin, node_9338_sin, node_9338_cos))+node_9338_piv);
                float4 _Refraction_var = tex2D(_Refraction,TRANSFORM_TEX(node_9338, _Refraction));
